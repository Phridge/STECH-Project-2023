...
class MainStoryScreen(Screen):
    def __init__(self, events, save):
        ...
        self.level3_button = ui_elements.BorderedSpriteButton("assets/images/city.gif", 42.5, 45, 15, 15, events.color_scheme, events, self.batch, foreground)
        ...
        self.level4_button = ui_elements.BorderedSpriteButton("assets/images/bridge.gif", 62.5, 45, 15, 15, events.color_scheme, events, self.batch, foreground)
