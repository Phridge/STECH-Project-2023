...
class MainStoryScreen(Screen):
    def __init__(self, events, save):
        ...
        self._subs.add(self.level4_label.clicked.subscribe(lambda _: self.push_screen(Level4Screen.init_fn())))
        # self._subs.add(self.level5_button.clicked.subscribe(lambda _: self.push_screen(Level5Screen.init_fn())))
        # self._subs.add(self.level5_label.clicked.subscribe(lambda _: self.push_screen(Level5Screen.init_fn())))
