...
class MainStoryScreen(Screen):
    ...
    def __init__(self, events, save):
        ...
        if self.story_progress >= 1: # SOLLTE EIGENTLICH 1 SEIN; IST NUR 0 DAMIT ES TROTZ BUGS SPIELBAR IST Level 2 nur spielbar wenn Level 1 bereits abgeschlossen wurde
        ...
        if self.story_progress >= 2: # SOLLTE EIGENTLICH 2 SEIN; IST NUR 0 DAMIT ES TROTZ BUGS SPIELBAR IST Level 3 nur spielbar wenn Level 2 bereits abgeschlossen wurde
        ...
        if self.story_progress >= 1: # SOLLTE EIGENTLICH 1 SEIN; IST NUR 0 DAMIT ES TROTZ BUGS SPIELBAR IST
        ...
        if self.story_progress >= 2: # SOLLTE EIGENTLICH 2 SEIN; IST NUR 0 DAMIT ES TROTZ BUGS SPIELBAR IST
