...
class Enemy():
  def __init__(self, events, batch, fx, fy, fwidth, fheight):
    ...
    self.gif = ui_elements.Gif("assets/images/enemy_walk_flipped.gif", self.x, self.y, self.own_width, self.own_height, 0.75, True, self.events, self.batch)

    self.header = ui_elements.BorderedRectangle("Type me", 20, 80, 60, 20, self.events.color_scheme, color_scheme.Minecraft, 2, self.events, self.batch)