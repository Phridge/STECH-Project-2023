...
class StartScreen(Screen):
    def __init__(self, events):
        ...
        self.background = ui_elements.Sprite("assets/images/mech_attack_1.png", 0, 0, 100, 100, events, self.batch)
        ...
        # self.statistic_lib = ui_elements.InputButton("Statistiken", 85, 85, 12.5, 10, events.color_scheme, color_scheme.Minecraft, 8.4, events, self.batch)
        ...
        # self._subs.add(self.statistic_lib.clicked.subscribe(goto(StatisticsScreen.init_fn(0))))
