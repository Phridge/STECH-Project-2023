...
class ErrorScreen:
    def __init__(self, events):
        ...
        self.header = ui_elements.BorderedRectangle("Es liegt ein Fehler vor :(", 20, 75, 60, 20, color_scheme.BlackWhite, color_scheme.Minecraft, 4, events, sublist, self.batch)
        self.restart_button = ui_elements.InputButton("Neu Starten", 35, 55, 30, 10, color_scheme.BlackWhite, color_scheme.Minecraft, 6, events, sublist, self.batch)
        self.end_button = ui_elements.InputButton("Spiel beenden", 35, 37.5, 30, 10, color_scheme.BlackWhite, color_scheme.Minecraft, 6, events, sublist, self.batch)
